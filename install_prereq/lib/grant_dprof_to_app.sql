DEFINE APP=&1
/***************************************************************************************************
Name: grant_dprof_to_app.sql              Author: Brendan Furey                      Date: 21-Jun-2020
...
====================================================================================================
This file is the driver script for the flat profiler prerequisite components to be run in the lib 
schema.
...
Grants applied:
    ...
    =================  =======================  ================
    ALL                plsql_profiler_runs      Table
    ALL                plsql_profiler_units     Table
    ALL                plsql_profiler_data      Table
    SELECT             plsql_profiler_runnumber Sequence

***************************************************************************************************/

PROMPT Granting plsql_profiler components to &APP...
GRANT ALL ON plsql_profiler_runs TO &APP
/
GRANT ALL ON plsql_profiler_units TO &APP
/
GRANT ALL ON plsql_profiler_data TO &APP
/
GRANT SELECT ON plsql_profiler_runnumber TO &APP
/
